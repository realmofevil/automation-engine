...
public final class CredentialDecoder {
    ...
    public static String decode(String encoded) {
        ...
        try {
            ...
            // Log warning but return original.
            // Useful during local development if a developer puts "password" instead of "cGFzc3dvcmQ="
            LOG.warn(
                    "Credential '{}' is not valid Base64. Using raw value. Ensure secrets are encoded in production config.",
                    obfuscate(encoded));
            return encoded;
        }
    }
